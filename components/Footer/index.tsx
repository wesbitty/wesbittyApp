...
const Footer = () => {
  ...
  return (
    <footer
      className="bg-white dark:bg-dark-800 border-t border-gray-200 dark:border-gray-600"
              ...
              {FooterLinks.map((segment: any) => {
                return (
                  <div key={`footer_${segment.title}`}>
                    <h3 className="text-base text-gray-800 dark:text-dark-100">{segment.title}</h3>
